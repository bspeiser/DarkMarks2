...
<%
	...
	if(sCatId==null)sCatId=request.getParameter("CAT_ID");
	...
	String sLotd = 	request.getParameter("lotd");
	if (sLotd==null) sLotd="3";
	if (mcur.gotoFirst()){		
		if(sCatId!=null){
			...
			%><jsp:include page="lotdlist.jsp"><jsp:param name='lotd' value='<%=sLotd%>'/></jsp:include><%
